...
const IdleIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16">
    ...
    <path d="M8 0a8 8 0 1 1 8 8 6 6 0 1 0-8-8z" fill="#FAA61A" />
  </svg>
);
...
const DndIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16">
    ...
    {/* Eksi işareti daha koyu gri yapıldı ve kalınlaştırıldı */}
    <rect x="3.5" y="7" width="9" height="2.5" fill="#5e6269" />
  </svg>
);

const OfflineIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16">
    {/* İçi boş, biraz daha kalın ve daha koyu gri halka */}
    <circle cx="8" cy="8" r="7" fill="none" stroke="#72767d" strokeWidth="2.5" />
  </svg>
);
      ...
      <div className="p-6 relative">
        <div className="flex items-center">
          ...
          <div className="relative w-20 h-20">
            ...
            {/* Custom Status Konuşma Balonu (yukarıya doğru) */}
            {customState && (
              <div className="absolute -top-14 right-0">
                <div className="relative inline-block">
                  <div className="bg-gray-700 text-white text-sm px-3 py-1.5 rounded-lg shadow-lg max-w-[160px] whitespace-normal break-words">
                    {customState}
                    {/* Balon bağlantı noktaları */}
                    <div className="absolute bottom-[-10px] right-3 flex space-x-1">
